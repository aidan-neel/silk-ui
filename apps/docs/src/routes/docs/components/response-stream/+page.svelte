...
<div data-docs-page class="flex flex-col gap-10">
	...
	<section id="usage" class="scroll-mt-20 flex flex-col gap-4">
		...
		<div class="flex flex-col gap-3">
			<div>
				<h3 class="text-sm font-[var(--font-weight-header,600)] text-foreground">Live responses</h3>
		...
		<div class="flex flex-col gap-3">
			<div>
				...
				<p class="mt-1 text-sm text-foreground-muted">
					For a complete string, use <code>speed</code> from 1 (slowest) to 100 (fastest) to control the
					reveal pace.
				</p>
			</div>
			<CodeBlock
