...
<div data-docs-page class="flex flex-col gap-10">
	...
	<section id="usage" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">
			Compose the menu from a trigger, full-screen content, grouped links, and an optional close
			control.
		</p>
		<CodeBlock
  ...
  <FullscreenNav.Content label="Site navigation">
	...
	<section id="behavior" class="scroll-mt-20 flex flex-col gap-3">
		...
		<ul class="flex list-disc flex-col gap-2 pl-5 text-sm text-foreground-muted">
			...
			<li>
				Pass a descriptive label to Content when the default navigation label is not specific
				enough.
			</li>
		</ul>
	</section>
	...
	<section id="examples" class="scroll-mt-20 flex flex-col gap-10">
		...
		<div id="custom-trigger" class="scroll-mt-20 flex flex-col gap-3">
			...
			<p class="text-sm text-foreground-muted">
				Pass content to Trigger to pair the menu icon with a visible label without changing its
				behavior.
			</p>
