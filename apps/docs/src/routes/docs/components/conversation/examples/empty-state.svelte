	...
	<Conversation.Content aria-label="Release planning conversation">
		{#if started}
			<Message.Root from="user">
				<Message.Content>Draft a release plan for the checkout reliability fix.</Message.Content>
			</Message.Root>
			<Message.Root from="assistant">
				<Message.Content>
					I’ll start with the rollout stages, owners, health checks, and rollback threshold.
				</Message.Content>
			</Message.Root>
		{:else}
			<Conversation.Empty
