...
<div data-docs-page class="flex flex-col gap-10">
	...
	<section id="usage" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">
			Control visibility with <code>bind:open</code>. <code>Cancel</code> and <code>Confirm</code>
			close the modal and fire their <code>onclick</code> callbacks. Use verb-first labels that name the
			exact action.
		</p>
		<CodeBlock
