...
<kbd
    ...
    class={cn(
        className,
        'inline-flex h-4 min-w-4 shrink-0 select-none items-center justify-center rounded-[var(--radius-sm)] border border-border bg-card px-1 align-middle font-sans text-[length:var(--font-size-meta)] font-medium leading-none text-foreground-muted',
