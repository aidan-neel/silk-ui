...
<textarea
	...
	class={cn(
		className,
		'min-h-12 max-h-52 w-full resize-none overflow-y-hidden bg-transparent px-3 pt-2.5 pb-1.5 [font-size:var(--font-size-body,16px)] leading-6 text-foreground outline-none placeholder:text-foreground-muted disabled:cursor-not-allowed disabled:opacity-50 read-only:cursor-default'
	)}
></textarea>
